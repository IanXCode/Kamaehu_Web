    ...
    <section id="download" className="section relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl text-foreground-muted max-w-2xl mx-auto mb-10">
          Log your first meal with our AI. See the component breakdown. Get your adaptive
          calorie targets. All free during beta.
        </p>
        ...
        <div className="flex flex-col items-center gap-6 mb-12">
          ...
          >
            ...
            <div className="text-left relative z-10">
              <div className="text-sm opacity-90">Download free on</div>
        ...
        <div className="bg-background-secondary rounded-2xl p-6 max-w-md mx-auto border border-primary/10 mb-10">
          <h3 className="font-semibold text-foreground mb-3">Get notified for Android</h3>
          <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 px-4 py-3 rounded-xl bg-background border border-primary/10 text-foreground placeholder:text-foreground-muted focus:outline-none focus:border-primary"
            />
            <button
              type="submit"
        ...
        <div className="flex flex-wrap justify-center gap-6 text-sm text-foreground-muted">
          {[
            ...
            { text: "Full AI food logging", icon: "ai" },
            { text: "Workout + nutrition", icon: "fitness" },
          ].map((item, index) => (
